...
class AuthorizationPayment extends AuthorizationController
{
    public function payment(Request $request)
    {
        $authorization = $this->validateRepeatedRequest($request, "PA");
        ...
        try {
            ...
            $this->registerMovement($card->Id, $request->all()['values']['billing_value'], $newBalance, 'PAYMENT');
